...
import { addToCart, upadateCartQuantity, removeFromCart, clearCart } from "../data/CartActionCreators";
...
const mapDispatchToProps = {
  loadData, addToCart, upadateCartQuantity, removeFromCart, clearCart, placeOrder
};
